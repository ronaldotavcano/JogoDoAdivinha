...
export default function App(){
    ...
    const [lettersUsed, setLetttersUsed] = useState<LettersUsedProps[]>([])
    const [challenge, setChallenge ] = useState<Challenge | null>(null)   

    function handleRestartGame(){
        const isConfirmed = window.confirm("Você tem certeza de que deseja reiniciar? ")
    ...
    function handleConfirm(){
        ...
        setLetttersUsed((prevState) => [...prevState, { value, correct}])
